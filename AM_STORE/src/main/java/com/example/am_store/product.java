...
public class product {
    ...
    void action_view(ActionEvent event) {
        loadScene2(event, "maincategory.fxml");
    ...
    @FXML
    void print(ActionEvent event) throws JRException, IOException, SQLException {

        Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres", "postgres", "12345");

        // Load the Jasper report design
        InputStream inp = new FileInputStream(new File("quantityproduct.jrxml"));
        ...
        if (pdfFile.exists()) {
            if (Desktop.isDesktopSupported()) {
                ...
                JOptionPane.showMessageDialog(null, "Desktop is not supported. Cannot open PDF.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } else {
