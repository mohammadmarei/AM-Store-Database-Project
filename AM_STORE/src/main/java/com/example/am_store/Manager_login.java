...
public class Manager_login {
    ...
    void handle_sign_in(ActionEvent event) {
        ...
        try (Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres", "postgres", "12345");
            ...
            stmtt.setString(1, "Manager");
            stmtt.setString(2, user);
            stmtt.setString(3, pass);

            ResultSet rs = stmtt.executeQuery();
            if (rs.next()) {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("manager(home).fxml"));
                ...
                JOptionPane.showMessageDialog(null, "Invalid username, password, or you are not authorized as Manager.");
            }
